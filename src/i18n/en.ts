...
const en = {
  ...
  'feishu.replyMode': 'Reply Mode',
  'feishu.replyModeInline': 'Inline — reply directly in chat',
  'feishu.replyModeThread': 'Thread — reply in message thread',
  'feishu.streaming': 'Streaming Cards',
  'feishu.streamingDesc': 'Stream responses via updateable cards (requires CardKit v2)',
  'feishu.blockStreaming': 'Block Streaming',
  'feishu.blockStreamingDesc': 'Stream responses at block level',
  'feishu.threadSession': 'Thread Sessions',
  'feishu.threadSessionDesc': 'Use message threads as separate conversation sessions',
