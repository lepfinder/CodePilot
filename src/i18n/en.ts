...
const en = {
  ...
  'feishu.encryptKeyPlaceholder': 'Encrypt Key from Feishu event subscription page',
  'feishu.encryptKeyHint': 'Optional, needed for HTTP Webhook mode (Feishu Console → Events & Callbacks → Encrypt Key)',
  'feishu.verificationToken': 'Verification Token',
  'feishu.verificationTokenPlaceholder': 'Verification Token from Feishu console',
  'feishu.verificationTokenHint': 'Optional, needed for HTTP Webhook mode (Feishu Console → Events & Callbacks → Verification Token)',
  ...
  'feishu.renderMode': 'Render Mode',
  'feishu.renderModeDesc': 'Control how the bot renders responses',
  'feishu.renderModeAuto': 'Auto — choose best rendering',
  'feishu.renderModeStatic': 'Static — send as plain text',
  'feishu.renderModeStreaming': 'Streaming — stream via cards',
  ...
  'feishu.blockStreaming': 'Block Streaming',
  'feishu.blockStreamingDesc': 'Stream responses at block level with coalesce buffering',
  ...
  'feishu.footer': 'Footer',
  'feishu.footerStatus': 'Show Status',
  'feishu.footerElapsed': 'Show Elapsed Time',
  ...
  'bridge.description': 'Control Claude from external channels like Telegram, WeCom, or Feishu',
  ...
  'bridge.defaultsApplyHint': 'Changes here apply to newly created bridge sessions. Existing channel chats keep their current bound session; send /new in the bridge chat to start a fresh session with the new provider/model.',
  ...
  'bridge.wecomChannel': 'WeCom',
  'bridge.wecomChannelDesc': 'Receive and respond to messages via WeCom AI Bot',
  'bridge.wecomSettings': 'WeCom Settings',
  'bridge.wecomSettingsDesc': 'Configure WeCom AI Bot credentials for bridge',
  ...
  // ── Settings: WeCom Bridge ─────────────────────────────────
  'wecom.credentials': 'Bot Credentials',
  'wecom.credentialsDesc': 'Enter your WeCom AI Bot ID and Secret',
  'wecom.botId': 'Bot ID',
  'wecom.secret': 'Secret',
  'wecom.verify': 'Test Connection',
  'wecom.verified': 'Connection verified',
  'wecom.verifiedAs': 'Connected as {name}',
  'wecom.verifyFailed': 'Connection failed',
  'wecom.enterCredentialsFirst': 'Enter Bot ID and Secret first',
  'wecom.allowedUsers': 'Allowed Users',
  'wecom.allowedUsersDesc': 'Comma-separated userid or chatid values allowed to use bridge',
  'wecom.allowedUsersHint': 'Leave empty to allow all users and chats',
  'wecom.groupSettings': 'Group Chat Settings',
  'wecom.groupSettingsDesc': 'Control how the bot responds in WeCom group chats',
  'wecom.groupPolicy': 'Group Policy',
  'wecom.groupPolicyOpen': 'Open — respond in all groups',
  'wecom.groupPolicyAllowlist': 'Allowlist — only specified groups',
  'wecom.groupPolicyDisabled': 'Disabled — ignore all group messages',
  'wecom.groupAllowFrom': 'Allowed Groups',
  'wecom.groupAllowFromHint': 'Comma-separated chatid values of allowed groups',
  'wecom.setupGuide': 'Setup Guide',
  'wecom.step1': 'Create or open your WeCom AI Bot in the Enterprise WeCom developer console',
  'wecom.step2': 'Copy the Bot ID and Secret from the bot credentials page',
  'wecom.step3': 'Paste the credentials above and click Save',
  'wecom.step4': 'Choose the group message policy and optionally configure an allowlist',
  'wecom.step5': 'Go back to the Bridge page, enable the WeCom channel toggle, and start the bridge',
  'wecom.step6': 'Open a bot chat or add the bot to a group chat, then send a message to test the bridge',
