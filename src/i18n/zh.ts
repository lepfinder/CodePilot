...
const zh: Record<TranslationKey, string> = {
  ...
  'feishu.replyMode': '回复模式',
  'feishu.replyModeInline': '内联 — 直接在聊天中回复',
  'feishu.replyModeThread': '话题 — 在消息话题中回复',
  'feishu.streaming': '流式卡片',
  'feishu.streamingDesc': '通过可更新卡片流式输出响应（需要 CardKit v2）',
  'feishu.blockStreaming': 'Block 流式',
  'feishu.blockStreamingDesc': '按 Block 级别流式输出响应',
  'feishu.threadSession': '话题会话',
  'feishu.threadSessionDesc': '将消息话题作为独立的对话会话',
