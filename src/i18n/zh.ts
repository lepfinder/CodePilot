...
const zh: Record<TranslationKey, string> = {
  ...
  'feishu.encryptKeyPlaceholder': '飞书后台「事件订阅」页面的 Encrypt Key',
  'feishu.encryptKeyHint': '可选，HTTP Webhook 模式需要（飞书后台 → 事件与回调 → Encrypt Key）',
  'feishu.verificationToken': 'Verification Token',
  'feishu.verificationTokenPlaceholder': '飞书后台的 Verification Token',
  'feishu.verificationTokenHint': '可选，HTTP Webhook 模式需要（飞书后台 → 事件与回调 → Verification Token）',
  'feishu.verify': '测试连接',
  ...
  'feishu.renderMode': '渲染模式',
  'feishu.renderModeDesc': '控制机器人如何渲染响应',
  'feishu.renderModeAuto': '自动 — 选择最佳渲染方式',
  'feishu.renderModeStatic': '静态 — 以纯文本发送',
  'feishu.renderModeStreaming': '流式 — 通过卡片流式输出',
  ...
  'feishu.blockStreaming': 'Block 流式',
  'feishu.blockStreamingDesc': '按 Block 级别流式输出响应（配合合并缓冲配置）',
  'feishu.threadSession': '话题会话',
  'feishu.threadSessionDesc': '启用每话题独立上下文（不同话题中的并行对话）',
  'feishu.footer': '页脚',
  'feishu.footerStatus': '显示状态',
  'feishu.footerElapsed': '显示耗时',
  ...
  'bridge.title': '远程桥接',
  'bridge.description': '通过 Telegram、企业微信、飞书等外部渠道控制 Claude',
  ...
  'bridge.defaultsApplyHint': '这里的修改只会作用于新创建的桥接会话。已有渠道聊天会继续绑定当前 session；请在桥接聊天里发送 /new，使用新的 provider / model 重新开始。',
  ...
  'bridge.wecomChannel': '企业微信',
  'bridge.wecomChannelDesc': '通过企业微信智能机器人接收和回复消息',
  'bridge.wecomSettings': '企业微信设置',
  'bridge.wecomSettingsDesc': '配置桥接使用的企业微信智能机器人凭据',
  ...
  'wecom.credentials': '机器人凭据',
  'wecom.credentialsDesc': '输入您的企业微信智能机器人 Bot ID 和 Secret',
  'wecom.botId': 'Bot ID',
  'wecom.secret': 'Secret',
  'wecom.verify': '测试连接',
  'wecom.verified': '连接验证成功',
  'wecom.verifiedAs': '已连接为 {name}',
  'wecom.verifyFailed': '连接失败',
  'wecom.enterCredentialsFirst': '请先输入 Bot ID 和 Secret',
  'wecom.allowedUsers': '允许的用户',
  'wecom.allowedUsersDesc': '允许使用桥接的 userid 或 chatid，逗号分隔',
  'wecom.allowedUsersHint': '留空则允许所有用户和会话',
  'wecom.groupSettings': '群聊设置',
  'wecom.groupSettingsDesc': '控制机器人在企业微信群聊中的响应方式',
  'wecom.groupPolicy': '群聊策略',
  'wecom.groupPolicyOpen': '开放 — 响应所有群消息',
  'wecom.groupPolicyAllowlist': '白名单 — 仅指定群组',
  'wecom.groupPolicyDisabled': '禁用 — 忽略所有群消息',
  'wecom.groupAllowFrom': '允许的群组',
  'wecom.groupAllowFromHint': '允许的群组 chatid，逗号分隔',
  'wecom.setupGuide': '设置指南',
  'wecom.step1': '前往企业微信开发者后台，创建或打开您的智能机器人',
  'wecom.step2': '在机器人凭据页面复制 Bot ID 和 Secret',
  'wecom.step3': '将凭据粘贴到上方后点击「保存」',
  'wecom.step4': '选择群聊消息策略，并按需配置群组白名单',
  'wecom.step5': '回到桥接主页，打开企业微信渠道开关并启动桥接',
  'wecom.step6': '打开机器人单聊或将机器人加入群聊，发送消息验证桥接链路',
